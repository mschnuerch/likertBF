...
library(knitr)
library(kableExtra)
library(stanModels) # dummy R package with precompiled Stan models (https://github.com/mschnuerch/stanModels)
source("00_helper.R")
...
shinyServer(function(input, output, session) {
    ...
    res <- eventReactive(input$analyze, {
        ...
        likertBF(Y1, Y2, b1, b2, chains, iter, warmup, updateProgress)
